...
class D3D12Renderer {
  private:
    ...
    ID3D12DescriptorHeap* m_cbv_srv_descriptor_heap = nullptr;
    UINT m_cbv_srv_desc_increment = 0;

    // Existing members...
    // ... rest of your existing class

    // Add these helper methods
    bool setup_cbv_srv_heap();
    void cleanup_cbv_srv_heap();
