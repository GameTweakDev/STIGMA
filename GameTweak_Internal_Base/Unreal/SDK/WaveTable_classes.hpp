...
{
public:
	uint8                                         Pad_32FA[0x8];                                     // 0x0028(0x0008)(Fixing Size After Last Property [ Dumper-69 ])
	...
	uint8                                         Pad_32FB[0x2];                                     // 0x0032(0x0002)(Fixing Size After Last Property [ Dumper-69 ])
	...
	uint8                                         Pad_32FC[0x7];                                     // 0x0039(0x0007)(Fixing Size After Last Property [ Dumper-69 ])
	TArray<struct FWaveTableBankEntry>            Entries;                                           // 0x0040(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_32FD[0x10];                                    // 0x0050(0x0010)(Fixing Struct Size After Last Property [ Dumper-69 ])
