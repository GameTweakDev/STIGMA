...
// WidgetBlueprintGeneratedClass UI_GN_ReviveEnemy.UI_GN_ReviveEnemy_C
// 0x0050 (0x0560 - 0x0510)
class UUI_GN_ReviveEnemy_C final : public UUI_GameNotify
{
public:
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"UI_GN_ReviveEnemy_C">();
	}
	static class UUI_GN_ReviveEnemy_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UUI_GN_ReviveEnemy_C>();
	}
};
static_assert(alignof(UUI_GN_ReviveEnemy_C) == 0x000008, "Wrong alignment on UUI_GN_ReviveEnemy_C");
static_assert(sizeof(UUI_GN_ReviveEnemy_C) == 0x000560, "Wrong size on UUI_GN_ReviveEnemy_C");
static_assert(offsetof(UUI_GN_ReviveEnemy_C, UI_OnShow) == 0x000510, "Member 'UUI_GN_ReviveEnemy_C::UI_OnShow' has a wrong offset!");
static_assert(offsetof(UUI_GN_ReviveEnemy_C, CanvasPanel_Alert) == 0x000518, "Member 'UUI_GN_ReviveEnemy_C::CanvasPanel_Alert' has a wrong offset!");
static_assert(offsetof(UUI_GN_ReviveEnemy_C, Image_215) == 0x000520, "Member 'UUI_GN_ReviveEnemy_C::Image_215' has a wrong offset!");
static_assert(offsetof(UUI_GN_ReviveEnemy_C, Img_Line_Bottom) == 0x000528, "Member 'UUI_GN_ReviveEnemy_C::Img_Line_Bottom' has a wrong offset!");
static_assert(offsetof(UUI_GN_ReviveEnemy_C, Img_Line_Top) == 0x000530, "Member 'UUI_GN_ReviveEnemy_C::Img_Line_Top' has a wrong offset!");
static_assert(offsetof(UUI_GN_ReviveEnemy_C, T_Revive) == 0x000538, "Member 'UUI_GN_ReviveEnemy_C::T_Revive' has a wrong offset!");
static_assert(offsetof(UUI_GN_ReviveEnemy_C, TXT_Message) == 0x000540, "Member 'UUI_GN_ReviveEnemy_C::TXT_Message' has a wrong offset!");
static_assert(offsetof(UUI_GN_ReviveEnemy_C, TeamText) == 0x000548, "Member 'UUI_GN_ReviveEnemy_C::TeamText' has a wrong offset!");
