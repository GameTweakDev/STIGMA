...
{
public:
	uint8                                         Pad_27ED[0xC0];                                    // 0x0000(0x00C0)(Fixing Struct Size After Last Property [ Dumper-69 ])
};
...
{
public:
	uint8                                         Pad_27EE[0xC];                                     // 0x0000(0x000C)(Fixing Struct Size After Last Property [ Dumper-69 ])
};
...
{
public:
	uint8                                         Pad_27EF[0x9];                                     // 0x0000(0x0009)(Fixing Struct Size After Last Property [ Dumper-69 ])
};
...
{
public:
	uint8                                         Pad_27F0[0xC8];                                    // 0x0000(0x00C8)(Fixing Struct Size After Last Property [ Dumper-69 ])
};
