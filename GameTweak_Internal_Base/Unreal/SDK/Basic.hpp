...
namespace Offsets
{
	constexpr int32 GObjects          = 0x079230F0;
	constexpr int32 AppendString      = 0x00CDA630;
	constexpr int32 GNames            = 0x0787CD00;
	constexpr int32 GWorld            = 0x07A91258;
	constexpr int32 ProcessEvent      = 0x00E94C80;
...
public:
	...
	uint8                                         Pad_0[0x10];                                       // 0x0008(0x0010)(Fixing Struct Size After Last Property [ Dumper-69 ])
};
...
{
public:
	uint8                                         Pad_1[0x28];                                       // 0x0000(0x0028)(Fixing Size After Last Property [ Dumper-69 ])
...
public:
	...
	uint8                                         Pad_2[0x10];                                       // 0x0008(0x0010)(Fixing Struct Size After Last Property [ Dumper-69 ])
...
public:
	...
	uint8                                         Pad_3[0x4];                                        // 0x001C(0x0004)(Fixing Size After Last Property [ Dumper-69 ])
...
public:
	...
	uint8                                         Pad_4[0x4];                                        // 0x0040(0x0004)(Fixing Size After Last Property [ Dumper-69 ])
	int32                                         Offset;                                            // 0x0044(0x0004)(NOT AUTO-GENERATED PROPERTY)
	uint8                                         Pad_5[0x28];                                       // 0x0048(0x0028)(Fixing Struct Size After Last Property [ Dumper-69 ])
};
...
{
public:
	uint8                                         Pad_6[0x8];                                        // 0x0070(0x0008)(Fixing Size After Last Property [ Dumper-69 ])
