...
{
public:
	uint8                                         Pad_168[0x950];                                    // 0x0028(0x0950)(Fixing Struct Size After Last Property [ Dumper-69 ])
...
{
public:
	uint8                                         Pad_16C[0x8];                                      // 0x0028(0x0008)(Fixing Struct Size After Last Property [ Dumper-69 ])
...
{
public:
	uint8                                         Pad_16D[0x8];                                      // 0x0028(0x0008)(Fixing Struct Size After Last Property [ Dumper-69 ])
...
{
public:
	uint8                                         Pad_16E[0x10];                                     // 0x0028(0x0010)(Fixing Struct Size After Last Property [ Dumper-69 ])
